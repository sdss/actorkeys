...
KeysDictionary("apogee", (1,0), *(
    ...
    Key("utrReadTime", Float(units="sec", invalid="nan"), help="time required for a UTR read"),
    ...
    Key("vacuum", 
        ...
        help="Current vacumm read by the primary gauge; NaN if not available (Torr)"),
    Key("vacuumAlt", 
        Float(units="Torr", invalid="nan"),
        help="Current vacumm read by the secondary gauge; NaN if not available (Torr)"),
    Key("vacuumInterval", 
        Float(units="sec", invalid="nan"),
