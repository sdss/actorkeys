KeysDictionary('guider', (0, 1),
    ...
    Key("cartridgeLoaded",
        ...
        Int(name="plateID", invalid=-1),
        String(name="pointing", invalid="?"),
    ),
    ...
    # corrections
    Key("axisError",
        Float(help="measured pointing error: az, alt, rot", unis="deg")*3,
    ),
    Key("axisChange",
    ...
    Key("yourUserNum", Int(), help="the user number of your connection"),
)
