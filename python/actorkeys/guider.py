KeysDictionary('guider', (1, 2),
    ...
    Key("guideRMS",
        Int(name="expID",   help="gcamera exposure number"),
        Float("RMSerror",   help="RMS of guide star offset from the fiber center)?"),
        ...
        Float("fitRMS",      help="RMS of fit to guide star offsets"),
        Int(name="nReject", help="Number of guide stars rejected form fit"),
        doCache = False,
    ),        
    Key("fwhm",         
        Int(name="expID", help="gcamera exposure number"),
