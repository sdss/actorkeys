...
KeysDictionary(
    ...
    Key('locked', Bool(False, True), help='is the FPS locked?'),
    Key('engineering_mode', Bool(False, True), help='is the FPS in engineering mode?'),
    ...
    Key('status',
        ...
        Bool(False, True, name='initialised', help='is the positioner initialised?'),
        Bool(False, True, name='disabled', help='is the positioner disabled?'),
        Bool(False, True, name='offline', help='is the positioner offline?'),
        Bool(False, True, name='bootloader', help='is the position in bootloader mode?'),
    ...
    Key('power_sextant', Bool(False, True) * (6,), help="Power to sextants"),
    Key('power_can', Bool(False, True) * (6,), help="Power to CAN modules"),
    Key('power_sync', Bool(False, True), help="Power to SYNC line"),
    Key('power_gfa', Bool(False, True) * (6,), help="Power to GFAs"),
    Key('power_nuc', Bool(False, True) * (6,), help="Power to GFA Nucs"),
    Key('fvc_temperature', Float() * (0,), help="FVC temperatures"),
    Key('fvc_power_nuc', Bool(False, True), help="Power to FVC NUC"),
    Key('fvc_power_camera', Bool(False, True), help="Power to FVC camera"),
