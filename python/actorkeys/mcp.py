KeysDictionary("mcp", (1,2),
    ...
    Key("sp1Slithead", Bool("0", "1", help="Slithead door open"), Bool("0", "1", help="Slithead door closed"),
        Bool("0", "1", help="Latch extended"), Bool("0", "1", help="Slithead in place")),
    Key("sp2Slithead", Bool("0", "1", help="Slithead door open"), Bool("0", "1", help="Slithead door closed"),
        Bool("0", "1", help="Latch extended"), Bool("0", "1", help="Slithead in place")),
    ...
    Key("altPidCoeffs", Int(help="Proportional term"), Int(help="Integral term"), Int(help="Derivitive term"),
        Int(help="Accel FF"), Int(help="Vel FF"), Int(help="Current limit"), Int(help="Offset"),
        Int(help="DAC limit"), Int(help="Shift"), Int(help="Friction FF"),
        help="Servo loop tuning parameters; for details see the MEI manual"),
