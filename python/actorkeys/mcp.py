...
KeysDictionary("mcp", (5,1),
    ...
    Key("semaphoreOwner", String()*(0,1), help="Name of user (self-reported) who owns the semaphore"),
    ...
    Key("sp2Slithead", 
        ...
        Bool("0", "1", help="Slithead in place")),
    Key("apogeeGang",
        Enum("0", "1", "2", "4", "12", "20", "36",labelHelp=("Unknown", "Disconnected", "At Cart", "Podium: (any)", "Podium: dense port", "Podium: sparse port", "Podium: 1m port"))),
    # Obsolete
    ...
    Key('ab_O1_L1', Bits('inst_lift_high_psi', 'inst_lift_up_4', 'inst_lift_up_3', 'inst_lift_up_2', 'inst_lift_up_1', 'inst_lift_dn_1', 'inst_lift_dn_2', 'inst_lift_dn_3', 'inst_lift_dn_4', 'lamp_on_enable', 'viktory_guardpin', 'az_stow_center_light', 'stop_bypass_strobe', 'az_stow_light', 'low_lvl_light_1', 'low_lvl_light_2', ), help=''),
