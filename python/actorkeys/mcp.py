...
KeysDictionary("mcp", (3,3),
    ...
    Key("ffsStatus", Enum("00", "01", "10", "11", labelHelp=("?", "Closed", "Open", "Invalid"))*8,
    ...
    Key("cwStatus", Enum("..", "L.", ".U", "LU", labelHelp=("InRange", "AtLowerLimit", "AtUpperLimit", "Invalid"))*4,
    ...
    #
    Key('ab_B3_L0', Bits('up_inhibit_latch', 'dn_inhibit_latch_1', 'dn_inhibit_latch_2', 'dn_inhibit_latch_3', 'dn_inhibit_latch_4', 'e_stop_permit', 'mcp_cont_slit_dr', 'plc_cont_slit_dr', 'mcp_cont_slit_hd', 'plc_cont_slit_hd', 'mcp_cont_t_bar_latch', 'plc_cont_t_bar_latch', 'flip_flop_0', 'flip_flop_1', 'flip_flop_2', 'flip_flop_3', 'flip_flop_4', 'flip_flop_5', 'led_flash', 'e_stop_flash_reset', 'ff_screens_closed', 'ilcb_led_on', 'lift_speed_man_ovrid', 'ne_lamp_on_request', 'hgcd_lamp_on_request', 'az_mtr_iv_good', 'alt_mtr_iv_good', 'rot_mtr_iv_good', ), help=''),
    Key('ab_B3_L1', Bits('disc_cable', 'no_inst_in_place', 'cartridge_1', 'cartridge_2', 'cartridge_3', 'cartridge_4', 'cartridge_5', 'cartridge_6', 'cartridge_7', 'cartridge_8', 'cartridge_9', 'eng_cam_in_place', 'undefined_3', 'undefined_1', 'undefined_2', 'img_cam_in_place', ), help=''),
    Key('ab_B3_L2', Bits('mcp_cont_slit_hd_os1', 'mcp_cont_slit_hd_os2', 'mcp_cont_slit_hd_os3', 'mcp_cont_slit_hd_os4', 'plc_cont_slit_hd_unl', 'plc_cont_slit_hd_lth', 'cor_in_place', 'cor_not_in_place', 'cartg_in_place', 'pri_latch_opn', 'pri_latch_cls', 'sec_latch_opn', 'sec_latch_cls', 'sad_latch_opn', 'sad_latch_cls', 'lift_empty', 'plc_cont_slit_dr_osr', 'plc_cont_slit_hd_osr', 'mcp_cont_t_bar_osr', 'plc_cont_t_bar_osr', 'plc_t_bar_xport', 'plc_t_bar_tel', 'mcp_cont_slit_dr_os1', 'mcp_cont_slit_dr_os2', 'mcp_cont_slit_dr_os3', 'mcp_cont_slit_dr_os4', 'plc_cont_slit_dr_opn', 'plc_cont_slit_dr_cls', 'sad_in_place', 'sad_not_in_place', ), help=''),
    Key('ab_B3_L3', Bits('img_cam_up_in_place', 'cartg_up_in_place', 'cor_up_in_place', 'eng_cam_up_in_place', 'empty_plate_on_lift', 'flex_io_fault', 'auto_mode_enable', 'cor_on_lift', 'cam_on_lift_wo_j_hok', 'cam_on_lift_w_j_hok', 'cartg_on_lift', 'cartg_on_lift_comp', 'eng_cam_on_lift', 'eng_cam_on_lift_comp', 'lift_force_up_enable', 'lift_force_dn_enable', 'lift_up_enable', 'lift_down_enable', 'speed_1', 'speed_2', 'speed_3', 'speed_4', ), help=''),
    ...
    Key('ab_B3_L7', Bits('spare_b3_15_0', 'spare_b3_15_1', 'spare_b3_15_2', 'spare_b3_15_3', 'spare_b3_15_4', 'spare_b3_15_5', 'spare_b3_15_6', 'spare_b3_15_7', 'spare_b3_15_8', 'spare_b3_15_9', 'spare_b3_15_10', 'spare_b3_15_11', 'spare_b3_15_12', 'spare_b3_15_13', 'spare_b3_15_14', 'spare_b3_15_15', 'cartridge_10', 'cartridge_11', 'cartridge_12', 'cartridge_13', 'cartridge_14', 'cartridge_15', 'cartridge_16', 'cartridge_17', 'spare_b3_14_8', 'spare_b3_14_9', 'spare_b3_14_10', 'spare_b3_14_11', 'spare_b3_14_12', 'spare_b3_14_13', 'spare_b3_14_14', 'spare_b3_14_15', ), help=''),
    ...
    Key('ab_I1_L0', Bits('dog_house_cw_pad', 'dog_house_ccw_pad', 'dog_house_door_opn', 'dog_house_door_cls', 'ops_cart_in_house', 'optical_bench_opn', 'optical_bench_cls', 'rack_0_grp_1_bit_7', 'rack_0_grp_1_bit_8', 'rack_0_grp_1_bit_9', 'rack_0_grp_1_bit_10', 'rack_0_grp_1_bit_11', 'rack_0_grp_1_bit_12', 'rack_0_grp_1_bit_13', 'rack_0_grp_1_bit_14', 'low_lvl_light_req', 'inst_lift_pump_on', 'inst_lift_sw1', 'inst_lift_sw2', 'inst_lift_sw3', 'inst_lift_sw4', 'inst_lift_dn', 'inst_lift_man', 'inst_lift_high_force', 'inst_lift_low_force', 'fiber_cart_pos1', 'fiber_cart_pos2', 'ops_cart_in_pos', 'rack_0_grp_0_bit_12', 'az_bump_cw', 'az_bump_ccw', 'rack_0_grp_0_bit_15', ), help=''),
    Key('ab_I1_L1', Bits('spare_i1_l1', ), help=''),
    Key('ab_I1_L2', Bits('spare_i1_l2', ), help=''),
    Key('ab_I1_L3', Bits('spare_i1_l3', ), help=''),
    Key('ab_I1_L4', Bits('slit_latch_unlth_cmd', 'slit_latch_lth_cmd', 'tbar_latch_xport_cmd', 'tbar_latch_tel_cmd', 'rack_1_grp_1_bit_4', 'rack_1_grp_1_bit_5', 'rack_1_grp_1_bit_6', 'rack_1_grp_1_bit_7', 'rack_1_grp_1_bit_8', 'rack_1_grp_1_bit_9', 'rack_1_grp_1_bit_10', 'rack_1_grp_1_bit_11', 'rack_1_grp_1_bit_12', 'rack_1_grp_1_bit_13', 'rack_1_grp_1_bit_14', 'rack_1_grp_1_bit_15', 'rot_inst_chg_a', 'rot_inst_chg_b', 'rot_neg_190_cw', 'rot_pos_370_ccw', 'ilcb_pres_good', 'inst_man_valve_cls', 'sec_man_valve_cls', 'sad_man_valve_cls', 'iclb_leds_on_cmd', 'off_mode_sw', 'auto_mode_sw', 'man_mode_switch', 'inst_chg_install_sw', 'inst_chg_remove_sw', 'close_slit_doors', 'open_slit_doors', ), help=''),
    Key('ab_I1_L5', Bits('spare_i1_l5', ), help=''),
    Key('ab_I1_L6', Bits('spare_i1_l6', ), help=''),
    Key('ab_I1_L7', Bits('spare_i1_l7', ), help=''),
    Key('ab_I1_L8', Bits('pri_latch1_opn', 'pri_latch1_cls', 'pri_latch2_opn', 'pri_latch2_cls', 'pri_latch3_opn', 'pri_latch3_cls', 'sec_latch1_opn', 'sec_latch1_cls', 'sec_latch2_opn', 'sec_latch2_cls', 'sec_latch3_opn', 'sec_latch3_cls', 'safety_latch1_opn', 'safety_latch1_cls', 'safety_latch2_opn', 'safety_latch2_cls', 'inst_id1_1', 'inst_id1_2', 'inst_id1_3', 'inst_id1_4', 'inst_id2_1', 'inst_id2_2', 'inst_id2_3', 'inst_id2_4', 'inst_id3_1', 'inst_id3_2', 'inst_id3_3', 'inst_id3_4', 'spec_lens1', 'spec_lens2', 'spec_autofill_on', 'rack_2_grp_0_bit_15', ), help=''),
    Key('ab_I1_L9', Bits('sad_latch1_opn', 'sad_latch1_cls', 'sad_latch2_opn', 'sad_latch2_cls', 'sad_mount1', 'sad_mount2', 'slit_head_door1_opn', 'slit_head_door1_cls', 'slit_head_latch1_ext', 'slit_head_1_in_place', 'slit_head_door2_opn', 'slit_head_door2_cls', 'slit_head_latch2_ext', 'slit_head_2_in_place', 'rack_2_grp_2_bit_14', 'rack_2_grp_2_bit_15', ), help=''),
    Key('ab_I1_L10', Bits('purge_air_pressur_sw', 'alt_bump_up', 'alt_bump_dn', 'sec_mir_force_limits', 'rack_2_grp_4_bit_4', 'rack_2_grp_4_bit_5', 'rack_2_grp_4_bit_6', 'rack_2_grp_4_bit_7', 'rack_2_grp_4_bit_8', 'rack_2_grp_4_bit_9', 'rack_2_grp_4_bit_10', 'rack_2_grp_4_bit_11', 'rack_2_grp_4_bit_12', 'rack_2_grp_4_bit_13', 'rack_2_grp_4_bit_14', 'rack_2_grp_4_bit_15', ), help=''),
    Key('ab_I1_L11', Bits('spare_i1_l11', ), help=''),
    Key('ab_I1_L12', Bits('rack_3_grp_1_bit_0', 'inst_lift_auto', 'man_lift_up_1', 'man_lift_up_2', 'man_lift_up_3', 'man_lift_up_4', 'man_lift_dn_1', 'man_lift_dn_2', 'man_lift_dn_3', 'man_lift_dn_4', 'rack_3_grp_1_bit_10', 'rack_3_grp_1_bit_11', 'rack_3_grp_1_bit_12', 'rack_3_grp_1_bit_13', 'rack_3_grp_1_bit_14', 'rack_3_grp_1_bit_15', 'spare_i1_l12', ), help=''),
    Key('ab_I1_L13', Bits('ff_1_stat', 'ff_2_stat', 'ff_3_stat', 'ff_4_stat', 'ne_1_stat', 'ne_2_stat', 'ne_3_stat', 'ne_4_stat', 'hgcd_1_stat', 'hgcd_2_stat', 'hgcd_3_stat', 'hgcd_4_stat', 'rack_3_grp_3_bit_12', 'rack_3_grp_3_bit_13', 'rack_3_grp_3_bit_14', 'rack_3_grp_3_bit_15', 'leaf_1_open_stat', 'leaf_1_closed_stat', 'leaf_2_open_stat', 'leaf_2_closed_stat', 'leaf_3_open_stat', 'leaf_3_closed_stat', 'leaf_4_open_stat', 'leaf_4_closed_stat', 'leaf_5_open_stat', 'leaf_5_closed_stat', 'leaf_6_open_stat', 'leaf_6_closed_stat', 'leaf_7_open_stat', 'leaf_7_closed_stat', 'leaf_8_open_stat', 'leaf_8_closed_stat', ), help=''),
    Key('ab_I1_L14', Bits('man_ff_scrn_opn_cmd', 'man_ff_scrn_en_cmd', 'man_ff_lamp_on_cmd', 'man_ne_lamp_on_cmd', 'man_hgcd_lamp_on_cmd', 'ff_man_cont_enable', 'man_im_ff_wht_req', 'man_im_ff_uv_req', 'rack_3_grp_4_bit_8', 'rack_3_grp_4_bit_9', 'rack_3_grp_4_bit_10', 'rack_3_grp_4_bit_11', 'rack_3_grp_4_bit_12', 'rack_3_grp_4_bit_13', 'rack_3_grp_4_bit_14', 'rack_3_grp_4_bit_15', ), help=''),
    Key('ab_I1_L15', Bits('spare_i1_l15', ), help=''),
    Key('ab_I2_L0', Bits('wind_az1_fault', 'wind_az2_fault', 'wind_az3_fault', 'wind_alt1_fault', 'wind_az_perm', 'wind_alt_perm', 'spare', ), help=''),
    Key('ab_I6_L0', Bits('alt_mtr_up_perm_in', 'alt_mtr_dn_perm_in', 'alt_mtr1_perm_in', 'alt_mtr2_perm_in', 'wind_alt_mtr_perm_in', 'alt_plc_perm_in', 'wind_alt_plc_perm_in', 'az_stow_3a', 'az_mtr_cw_perm_in', 'az_mtr_ccw_perm_in', 'az_mtr1_perm_in', 'az_mtr2_perm_in', 'wind_az_mtr_perm_in', 'az_plc_perm_in', 'wind_az_plc_perm_in', 'az_stow_3b', 'tcc_stop', 'cr_stop', 'spare_s1_c2', 'fiber_signal_loss', 'n_wind_stop', 'n_fork_stop', 'n_rail_stop', 's_rail_stop', 'w_rail_stop', 'n_lower_stop', 's_lower_stop', 'e_lower_stop', 'w_lower_stop', 's_wind_stop', 'nw_fork_stop', 'mcp_watchdog_timer', ), help=''),
    Key('ab_I7_L0', Bits('alt_grt_83_limit_1', 'bldg_clear_alt', 'az_stow_2a', 'az_stow_2b', 'deg_15_stop_ext', 'alt_grt_18d6_limit_2', 'alt_slip', 'alt_velocity_limit', 'az_dir_cw', 'az_dir_ccw', 'az_neg_201a_cw', 'az_pos_445a_ccw', 'az_neg_201b_cw', 'az_pos_445b_ccw', 'spare_s8_c6', 'spare_s8_c7', 'rot_mtr_cw_perm_in', 'rot_mtr_ccw_perm_in', 'rot_mtr_perm_in', 'spare_s5_c3', 'bldg_perm_in', 'rot_plc_perm_in', 'hatch_cls', 'alt_les_2d5_limit', 'alt_grt_0d3_limit', 'alt_locking_pin_out', 'alt_les_90d5_limit', 'bldg_on_alt', 'az_109_131_limit_1', 'alt_grt_18d6_limit_1', 'az_stow_1a', 'az_stow_1b', ), help=''),
    Key('ab_I8_L0', Bits('az_stow_cntr_sw', 'az_110_130_limit', 'az_neg_196_cw', 'az_pos_440_ccw', 'az_mtr1_rdy', 'az_mtr2_rdy', 'alt_mtr1_rdy', 'alt_mtr2_rdy', 'rot_mtr_rdy', 'umbilical_strain_sw', 'e_stop_byp_sw', 'deg_15_stop_ret', 'in_8_bit_28_spare', 'in_8_bit_29_spare', 'in_8_bit_30_spare', 't_bar_xport_stat', 'alt_grt_18d6_limit_3', 'bldg_on_az', 'az_109_131_limit_2', 'alt_grt_83_limit_2', 'bldg_clear_az', 'spare_s9_c5', 'az_slip', 'az_velocity_limit', 'rot_dir_cw', 'rot_dir_ccw', 'rot_neg_200a_cw', 'rot_pos_380a_ccw', 'rot_neg_200b_cw', 'rot_pos_380b_ccw', 'rot_slip', 'rot_velocity_limit', ), help=''),
    Key('ab_I9_L0', Bits('s1_c0_bypass_sw', 's1_c1_bypass_sw', 's1_c2_bypass_sw', 's1_c3_bypass_sw', 's1_c4_bypass_sw', 's1_c5_bypass_sw', 's1_c6_bypass_sw', 's1_c7_bypass_sw', 's2_c0_bypass_sw', 's2_c1_bypass_sw', 's2_c2_bypass_sw', 's2_c3_bypass_sw', 's2_c4_bypass_sw', 's2_c5_bypass_sw', 's2_c6_bypass_sw', 's2_c7_mcp_wtchdg_byp', 't_bar_tel_stat', 'clamp_en_stat', 'clamp_dis_stat', 'az_brake_en_stat', 'az_brake_dis_stat', 'alt_brake_en_stat', 'alt_brake_dis_stat', 'low_lvl_lighting_req', 'solenoid_engage_sw', 'alt_locking_pin_in', 'in_9_bit_10_spare', 'in_9_bit_11_spare', 'in_9_bit_12_spare', 'in_9_bit_13_spare', 'in_9_bit_14_spare', 'in_9_bit_15_spare', ), help=''),
    Key('ab_I10_L0', Bits('lift_force_gt_f_cartridge_mount', 'lift_height_gt_h_cartridge_mount', 'in_10_bit_18_spare', 'in_10_bit_19_spare', 'in_10_bit_20_spare', 'in_10_bit_21_spare', 'in_10_bit_22_spare', 'in_10_bit_23_spare', 'in_10_bit_24_spare', 'in_10_bit_25_spare', 'in_10_bit_26_spare', 'in_10_bit_27_spare', 'in_10_bit_28_spare', 'in_10_bit_29_spare', 'in_10_bit_30_spare', 'in_10_bit_31_spare', 'alt_position_lt_90_15', 'alt_position_gt_89_75', 'alt_position_lt_90_2', 'alt_position_lt_90_29', 'alt_position_lt_91_0', 'alt_position_gt_89_8', 'alt_position_gt_0_50', 'alt_position_gt_19_5', 'alt_position_gt_0_8', 'alt_position_lt_18_5', 'alt_position_gt_15_0', 'alt_position_gt_15_5', 'alt_position_gt_83_5', 'alt_pos_lt_0_2', 'alt_pos_gt_neg_2', 'umbilical_dn', ), help=''),
    Key('ab_O1_L0', Bits('spare_o1_l0', ), help=''),
    Key('ab_O1_L1', Bits('inst_lift_high_psi', 'inst_lift_up_4', 'inst_lift_up_3', 'inst_lift_up_2', 'inst_lift_up_1', 'inst_lift_dn_1', 'inst_lift_dn_2', 'inst_lift_dn_3', 'inst_lift_dn_4', 'lamp_on_enable', 'rack_0_grp_2_bit_10', 'az_stow_center_light', 'stop_bypass_strobe', 'az_stow_light', 'low_lvl_light_1', 'low_lvl_light_2', ), help=''),
    Key('ab_O1_L2', Bits('spare_o1_l2', ), help=''),
    Key('ab_O1_L3', Bits('spare_01_l3', ), help=''),
    Key('ab_O1_L4', Bits('spare_o1_l4', ), help=''),
    Key('ab_O1_L5', Bits('slit2_unlatched_led', 'slit2_latched_led', 'slit_unlatch_prm_led', 'slit_latch_prm_led', 'inst_latch1_opn_led', 'inst_latch1_cls_led', 'inst_latch2_opn_led', 'inst_latch2_cls_led', 'inst_latch3_opn_led', 'inst_latch3_cls_led', 'inst_unlatch_perm', 'inst_latch_perm', 'sec_latch1_opn_led', 'sec_latch1_cls_led', 'sec_latch2_opn_led', 'sec_latch2_cls_led', 'cor_on_lift_led', 'cam_on_lift_led', 'cartg_on_lift_led', 'eng_on_lift_led', 'cor_in_place_led', 'cam_in_place_led', 'cartg_in_place_led', 'eng_in_place_led', 'sad_in_place_led', 'jhook_in_place_led', 'dog_door_open_led', 'cam_crt_in_house_led', 'cart_in_place_led', 'lift_down_led', 'slit1_unlatched_led', 'slit1_latched_led', ), help=''),
    Key('ab_O1_L6', Bits('slit_dr1_cls_led', 'slit_dr1_opn_led', 'slit_dr2_cls_led', 'slit_dr2_opn_led', 'ilcb_pres_led', 'inst_latch_air_led', 'sec_latch_air_led', 'sad_latch_air_led', 'manual_mode_led', 'saf_latch1_opn_led', 'saf_latch1_cls_led', 'saf_latch2_opn_led', 'saf_latch2_cls_led', 'rack_1_grp_5_bit_13', 'rack_1_grp_5_bit_14', 'rack_1_grp_5_bit_15', 'sec_latch3_opn_led', 'sec_latch3_cls_led', 'sec_unlatch_perm', 'sec_latch_perm', 'sad_latch1_opn_led', 'sad_latch1_cls_led', 'sad_latch2_opn_led', 'sad_latch2_cls_led', 'sad_unlatch_perm', 'sad_latch_perm', 'tbar_xport_led', 'tbar_tel_led', 'tbar_xport_perm_led', 'tbar_tel_perm_led', 'slit_dr_cls_perm_led', 'slit_dr_opn_perm_led', ), help=''),
    Key('ab_O1_L7', Bits('spare_o1_l7', ), help=''),
    Key('ab_O1_L8', Bits('spare_o1_l8', ), help=''),
    Key('ab_O1_L9', Bits('slit_dr1_cls_perm', 'slit_dr1_opn_perm', 'slit_latch1_ext_perm', 'slit_dr2_cls_perm', 'slit_dr2_opn_perm', 'slit_latch2_ext_perm', 'rack_2_grp_3_bit_6', 'rack_2_grp_3_bit_7', 'rack_2_grp_3_bit_8', 'rack_2_grp_3_bit_9', 'rack_2_grp_3_bit_10', 'rack_2_grp_3_bit_11', 'rack_2_grp_3_bit_12', 'rack_2_grp_3_bit_13', 'rack_2_grp_3_bit_14', 'rack_2_grp_3_bit_15', 'spare_o1_l9', ), help=''),
    Key('ab_O1_L10', Bits('purge_valve_permit', 'rack_2_grp_5_bit_1', 'rack_2_grp_5_bit_2', 'rack_2_grp_5_bit_3', 'rack_2_grp_5_bit_4', 'rack_2_grp_5_bit_5', 'rack_2_grp_5_bit_6', 'rack_2_grp_5_bit_7', 'rack_2_grp_5_bit_8', 'rack_2_grp_5_bit_9', 'rack_2_grp_5_bit_10', 'rack_2_grp_5_bit_11', 'rack_2_grp_5_bit_12', 'rack_2_grp_5_bit_13', 'rack_2_grp_5_bit_14', 'audio_warning_2', 'spare_o1_l10', ), help=''),
    Key('ab_O1_L11', Bits('spare_o1_l11', ), help=''),
    Key('ab_O1_L12', Bits('spare_o1_l12', ), help=''),
    Key('ab_O1_L13', Bits('spare_o1_l13', ), help=''),
    Key('ab_O1_L14', Bits('ff_screen_open_pmt', 'ff_screen_enable_pmt', 'ff_lamps_on_pmt', 'ne_lamps_on_pmt', 'hgcd_lamps_on_pmt', 'ff_screen2_open_pmt', 'ff_screen2_enable_pm', 'im_ff_wht_on_pmt', 'im_ff_uv_on_pmt', 'rack_4_grp_5_bit_9', 'rack_4_grp_5_bit_10', 'rack_4_grp_5_bit_11', 'rack_4_grp_5_bit_12', 'rack_4_grp_5_bit_13', 'rack_4_grp_5_bit_14', 'audio_warning_1', 'spare_o1_l14', ), help=''),
    Key('ab_O1_L15', Bits('spare_o1_l15', ), help=''),
    Key('ab_O2_L0', Bits('wind_mtr_cw_perm', 'wind_mtr_ccw_perm', 'wind_mtr_up_perm', 'wind_mtr_dn_perm', 'out_2_bit_20_spare', 'out_2_bit_21_spare', ), help=''),
    Key('ab_O11_L0', Bits('e_ll_led', 'w_ll_led', 'n_wind_led', 'n_fork_led', 's_wind_led', 'lift_solenoid_en', 'deg_15_stop_ext_perm', 'deg_15_stop_ret_perm', 'out_11_bit_24_spare', 'out_11_bit_25_spare', 'lift_pump_on', 'out_11_bit_27_spare', 't_bar_tel_perm', 't_bar_xport_perm', 'clamp_dis', 'clamp_en', 'alt_mtr_up_perm', 'alt_mtr_dn_perm', 'alt_plc_perm', 'wind_alt_plc_perm', 'az_mtr_cw_perm', 'az_mtr_ccw_perm', 'az_plc_perm', 'wind_az_plc_perm', 'rot_mtr_cw_perm', 'rot_mtr_ccw_perm', 'rot_plc_perm', 'n_rail_led', 's_rail_led', 'w_rail_led', 'n_ll_led', 's_ll_led', ), help=''),
    Key('ab_O12_L0', Bits('out_12_bit_16_spare', 'out_12_bit_17_spare', 'out_12_bit_18_spare', 'out_12_bit_19_spare', 'out_12_bit_20_spare', 'out_12_bit_21_spare', 'out_12_bit_22_spare', 'out_12_bit_23_spare', 'out_12_bit_24_spare', 'out_12_bit_25_spare', 'out_12_bit_26_spare', 'out_12_bit_27_spare', 'out_12_bit_28_spare', 'out_12_bit_29_spare', 'out_12_bit_30_spare', 'out_12_bit_31_spare', 'az_brake_dis', 'az_brake_en', 'alt_brake_dis', 'alt_brake_en', 'umbilical_on_off', 'umbilical_up_dn', 'nw_fork_led', 'inst_chg_pos_light', 'stow_pos_light', 'velocity_select_bit', 'velocity_trp_rst_out', 'lift_enable', 'umbilical_fast', 'out_12_bit_13_spare', 'out_12_bit_14_spare', 'out_12_bit_15_spare', ), help=''),
)
