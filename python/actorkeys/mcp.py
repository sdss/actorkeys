KeysDictionary("mcp", (1,1),
    ...
    Key("badUid", Int(), help="UserID on command does not match"),
    ...
    Key("ffsStatus", Enum("00", "01", "10", "11", descr=("?", "Closed", "Open", "Invalid"))*8, help="State of flat field petals 1-8"),
    Key("ffsCommandedOn", Bool("false", "true"), help="Flat field petals commanded close/open"),
    Key("ffsSelected", Enum("00", "01", "10", "11", descr=("None", "Half1", "Half2", "All")), help="Flat field petals enabled"),
    ...
    Key("plcFiducialVersion", Int(), help="Version of PCL code"),
