KeysDictionary("platedb", (1,2),
    ...
    Key("gprobe",
        ...
        Float(xcen, units="pixels", help="w.r.t (0.5, 0.5) at center of LL pixel"),
        Float(ycen, units="pixels", help="w.r.t (0.5, 0.5) at center of LL pixel"),
        Float(radius, help="pixels"),
        Float(name="rotation", units="degrees", help="+CCW, image Y to plate N. WRT offset image"),
        Float(xferruleOffset, units="microns", help="applied before rotation"),
        Float(yferruleOffset, units="microns", help="applied before rotation"),
