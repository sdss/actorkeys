KeysDictionary("platedb", (1,9),
    ...
    Key('guideWavelength', Float(invalid='?'), help='The wavelength at which we are guiding.'),
    Key("apogeeDesign",
    ...
    Key('mangaExposureTime',
        Float(name='exposureTime',
              help='The MaNGA exposure time requested for this plate.',
              invalid=-1),
        help='The MaNGA exposur time to be used for configuring SOP.',
    ),
