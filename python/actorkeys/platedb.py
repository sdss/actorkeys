KeysDictionary("platedb", (1,7),
    ...
    Key("apogeeDesign",
        String(name="type",help="The apogee design type of this plate",invalid=None),
        Float(name="exposureTime",help="The apogee exposure time requested for this plate.",invalid=None),
