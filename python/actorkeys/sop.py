...
# MISSING KEYS due to unknown format: sp1 and sp2
    ...
    Key("availableScripts",help="List of available SOP scripts.",
        String("name")*(1,)),
    Key("scriptState",help="status of currently active SOP script.",
    ...
    Key("scriptLine",help="lines in currently active SOP script.",
        String("name",help="Name of currently active SOP script."),
