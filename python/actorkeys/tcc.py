...
KeysDictionary("tcc", (3, 2),
    ...
    Key("gSDataPix", Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Int(invalid="NaN")),
    Key("gSMag", Float(invalid="NaN")),
    Key("gSName", String()),
    Key("gSPM", Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN")),
    Key("gSPos", Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN")), # PVT*2
    Key("gSSys", String(), Float(invalid="NaN")),
    Key("gSWavelength", Float(invalid="NaN")),
    Key("gScanSize", Float(invalid="NaN"), Float(invalid="NaN")),
    Key("gStats", Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN")),
    Key("guideOff", Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN"), Float(invalid="NaN")), # PVT*3
    Key("guidePrep"),
    Key("guideStart"),
