...
KeysDictionary(
    ...
    Key("altReply", String(), help="Unparsed reply from the altitude axis controller"),
    Key(
        "altStat",
    ...
    Key(
        "axisNoSlew",
        String(
            help="A string of three characters corresponding to azimuth, "
    ...
    Key("azReply", String(), help="Unparsed reply from the azimuth axis controller"),
    Key(
        "azStat",
        Float(name="pos", invalid="nan", units="deg", help="position"),
        Float(name="vel", invalid="nan", units="deg/sec", help="velocity"),
    ...
    Key(
        "convPM",
        Float(name="polMotion", invalid="nan", units="as/century", help="proper motion")
        * 2,
    ...
    Key(
        "gProbe", Int(invalid="nan"), help="deprecated (use gProbeInfo)", doCache=False
    ),
    Key(
        "gProbeInfo",
...
pos. (unbinned pixels) = offset + scale * pos. (deg)",
    ...
    Key(
        "instPos",
        Enum(
            "NA1", "NA2", "BC1", "TR1", "TR2", "SK1", "SK2", "SK3", "SK4", "CA1", "non"
        ),
    ...
    Key(
        "ipConfig",
        String(
            help="A string of three characters corresponding to availablity "
    ...
    Key(
        "moveItems",
        String(
            help="A 9 character string; each character is either "
    ...
    Key(
        "primReply", String(), help="Unparsed reply from the primary mirror controller"
    ),
    Key(
        "primState",
        String(
    ...
    Key(
        ...
        Float(
            name="xPos", invalid="nan", units="deg", help="x position in pointing frame"
        ),
        Float(
            name="yPos", invalid="nan", units="deg", help="y position in pointing frame"
        ),
    ...
    Key(
        ...
        Float(
            name="polMotion", invalid="nan", help="polar proper motion (arcsec/year)"
        ),
        Float(
            name="radVel",
            invalid="nan",
    ...
    Key(
        "rotInstXYAng",
        Float(
            name="x", invalid="nan", units="deg", help="x position in coordinate frame"
        ),
        Float(
            name="y", invalid="nan", units="deg", help="y position in coordinate frame"
        ),
        Float(
            name="rot",
            invalid="nan",
    ...
    Key("rotReply", String(), help="Unparsed reply from the rotator axis controller"),
    Key(
        "rotStat",
        Float(name="pos", invalid="nan", units="deg", help="position"),
        Float(name="vel", invalid="nan", units="deg/sec", help="velocity"),
    ...
    Key(
        "secReply", String(), help="Unparsed reply from the secondary mirror controller"
    ),
    Key(
        "secState",
        String(
    ...
    Key(
        ...
        Float(
            name="alt", invalid="nan", units="deg", strFmt="%+07.2f", help="altitude"
        ),
    ...
    Key(
        "tertReply", String(), help="Unparsed reply from the tertiary mirror controller"
    ),
    Key(
        "tertState",
        String(
