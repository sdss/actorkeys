...
KeysDictionary("tcc", (3, 2),
    ...
    Key("gBinFactor", Int(), Int()),
    Key("gBoxSize", Float(), Float()),
    Key("gCView", String()),
    Key("gCamBusy"),
    Key("gCamCmd", String()),
    Key("gCamID", Int(), Int()),
    Key("gCamInfo", String(), Int(), Int(), Int()),
    Key("gCamReply", String()),
    Key("gFitChiSq", Float()),
    Key("gImCtr", Float(), Float()),
    Key("gImLim", Int(), Int(), Int(), Int()),
    Key("gImScale", Float(), Float()),
    Key("gPCentroid", Int()*(0,)),
    Key("gPCtr", Float(), Float()),
    Key("gPDisable", Int()*(0,)),
    Key("gPFindStar", Int()*(0,)),
    Key("gPLim", Float(), Float(), Float(), Float()),
    Key("gPNoStar", Int()*(0,)),
    Key("gPRotGImAng", Float()),
    Key("gPRotXY", Float(), Float()),
    Key("gProbe", Int()),
    Key("gSDataPix", Float(), Float(), Float(), Float(), Float(), Float(), Float(), Float(), Int()),
    Key("gSMag", Float()),
    Key("gSName", String()),
    Key("gSPM", Float(), Float(), Float(), Float()),
    Key("gSPos", Float(), Float(), Float(), Float(), Float(), Float()), # PVT*2
    Key("gSSys", String(), Float()),
    Key("gSWavelength", Float()),
    Key("gScanSize", Float(), Float()),
    Key("gStats", Float(), Float(), Float(), Float(), Float(), Float()),
    Key("guideOff", Float(), Float(), Float(), Float(), Float(), Float(), Float(), Float(), Float()), # PVT*3
    Key("guidePrep"),
    Key("guideStart"),
