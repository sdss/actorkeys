...
KeysDictionary(
    ...
    Key("next_exposure_no", Int(), help="Exposure number for the ongoing expose"),
    Key("filenames", String() * (0,), help="Files saved to disk"),
    Key("lines", Int(), help="Number of lines (rows) in the CCD"),
    Key("pixels", Int(), help="Number of pixels (columns) in the CCD"),
    Key("preskiplines", Int()),
    Key("postskiplines", Int()),
    Key("preskippixels", Int()),
    Key("postskippixels", Int()),
    Key("overscanpixels", Int()),
